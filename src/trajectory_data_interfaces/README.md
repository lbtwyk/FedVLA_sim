...
A ROS 2 package providing custom service definitions for the trajectory data collection system. This package defines the communication interfaces between data collection nodes and robot control systems.
