...
def main():
    ...
    parser.add_argument("--log-frequency", type=float, default=10.0,
                        help="Frequency for logging data in Hz (default: 10.0)")
    ...
    for episode in range(1, args.num_episodes + 1):
        ...
        print("Waiting for system initialization (30 seconds)...")
        time.sleep(30)
        ...
        if episode < args.num_episodes:
            print("Waiting 5 seconds before starting next episode...")
            time.sleep(5)
